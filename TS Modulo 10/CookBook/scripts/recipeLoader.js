...
var RecipeLoader = (function () {
    ...
    RecipeLoader.prototype.mapData = function (data) {
        ...
        if (data) {
            ...
            recipeCategories = new RecipeData.RecipeCategories();
            //TODO
            ...
            var recipeCategoriesSummary = new RecipeData.RecipeCategories();
            ...
            renderer.renderCategory(recipeCategories.items[0]);
        }
        else {
